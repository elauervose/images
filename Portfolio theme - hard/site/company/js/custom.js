...
// Services on mouse over image animation 
	var $container2	 	= $('#service-box');
	$container2.find('img').adipoli({
		'hoverEffect' 	: 'boxRainGrowReverse',
		'startEffect' : 'transparent',
		'animSpeed' 	: 200,
	});
...
***************************************************/
	...
	// on  click navigation	
		...
		switch (name)
			...
			case 'home':
			$('#home').show();
			$('#aboutus,#services,#portfolio,#contact').hide();
			break;
			...
			case 'aboutus':
			$('#aboutus').show();
			$('#home,#services,#portfolio,#contact').hide();
			break;
			
			case 'services':	 
			$('#services').show();
			$('#aboutus,#home,#portfolio,#contact').hide();
			break;
			
			case 'portfolio':
			$('#portfolio').show();
			$('#aboutus,#home,#services,#contact').hide();
			break;

			
			case 'contact':
			$('#contact').show();
			$('#aboutus,#home,#services,#portfolio').hide();
			break;
